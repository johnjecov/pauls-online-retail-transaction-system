 ...
 */
@WebServlet(name = "deleteFServlet", urlPatterns = {"/deleteOrder"})
public class deleteFServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Mag dedelete ng Order si "+order_id);
